            ...
            <div className="flex flex-col items-center justify-center p-8 sm:p-20 bg-white">
                <div className="w-full max-w-md space-y-8">
                    <div className="text-center lg:text-left">
                        <h1 className="text-3xl font-black tracking-tight text-slate-900">Sign in to your account</h1>
                    ...
                    <form onSubmit={handleSubmit} className="space-y-6 mt-8">
                        ...
                        <div className="flex items-center justify-between">
                            <div className="flex items-center">
                                <input id="remember-me" type="checkbox" className="h-4 w-4 text-first-color focus:ring-first-color border-gray-300 rounded" />
                            ...
                            <div className="text-sm">
                                <a href="#" className="font-bold text-first-color hover:text-emerald-700">
                                    Forgot password?
                                </a>
                            </div>
                        </div>
                    ...
                    <div className="relative mt-10">
                        ...
                        <div className="relative flex justify-center text-sm">
                            <span className="px-4 bg-white font-bold text-slate-400">Or continue with</span>
                        </div>
                    </div>
